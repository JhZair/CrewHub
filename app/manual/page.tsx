...
export const metadata: Metadata = { title: "📖 Manual de CrewHUB+" };

/* 📖 EL MANUAL DE CREWHUB+ — vivía en /wiki; desde que /wiki es la wiki
   técnica de realización audiovisual, el manual de uso de la herramienta
   está aquí, en /manual, sin cambiar una línea de su contenido.
